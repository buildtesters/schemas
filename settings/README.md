...
| slurm | object | YES | Define a list of slurm executors. These executors can be used in Buildspec to run jobs via Slurm scheduler | 

## executor - local object

| Name | Type | Supported in buildtest | Description | 
| ---- | ---- | -----------------------| ----------- | 
| description | string | YES | Specify description field for executor |
| shell | string | YES | Specify shell command to use when running all jobs with the local executor. |
...
# executor - slurm object

| Name | Type | Supported in buildtest | Description | 
| ---- | ---- | -----------------------| ----------- | 
| description | string | YES | Specify description field for executor |
| launcher | string | YES | Specify slurm launcher to use when submitting job. Currently we support `sbatch`. |
...
| options | array | YES | Specify a list of options to pass to the `launcher` key |
...
| Name | Type | Supported in buildtest | Description | 
| ---- | ---- | -----------------------| ----------- | 
| description | string | NO | Specify description field for executor |
...
| paths | object | YES | Specify path configuration for buildtest settings  |
